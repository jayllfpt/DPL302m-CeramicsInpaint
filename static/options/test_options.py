...
class TestOptions:
    ...
    def initialize(self):
        self.parser.add_argument('--dataset', type=str, default='./yesuredata/test',
                                 help='The dataset of the experiment.')
        self.parser.add_argument('--data_file', type=str, default='./yesuretxt/text.txt', help='the file storing testing file paths')
        self.parser.add_argument('--test_dir', type=str, default='./', help='result are saved here')
